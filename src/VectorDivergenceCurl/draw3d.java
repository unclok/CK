...
import VectorDivergenceCurl.draw3d.VecFunction;
import VectorDivergenceCurl.draw3d.BUILD_CASE_EMV;
...
public class draw3d {
    ...
    static class BUILD_CASE_EMV{
        private boolean BUILD_E = false;
        private boolean BUILD_M = false;
        private boolean BUILD_V = false;
        
        private VecFunction E;
        private VecFunction M;
        private VecFunction V;
        
        private String eName;
        private String mName;
        private String vName;

        public BUILD_CASE_EMV(){
        }

        public BUILD_CASE_EMV(VecFunction E, VecFunction M, VecFunction V){
            this.E = E;
            this.M = M;
            this.V = V;
        }
     
        public BUILD_CASE_EMV(String Ename, String Mname, String Vname){
            this.eName = Ename;
            this.mName = Mname;
            this.vName = Vname;
        }
        ...
        private void changeBUILD(){
            if(this.E!=null)BUILD_E=true;
            if(this.M!=null)BUILD_M=true;
            if(this.V!=null)BUILD_V=true;
        }
        
        public boolean getBUILD_E(){
            return this.BUILD_E;
        }

        public boolean getBUILD_M(){
            return this.BUILD_M;
        }

        public boolean getBUILD_V(){
            return this.BUILD_V;
        }
    
        public VecFunction getVecFunction(){
            if(this.BUILD_E)return E;
            else if(this.BUILD_M)return M;
            else if(this.BUILD_V)return V;
            else return null;
        }
        
        public String getName(){
            String temp="";
            if(this.eName!=null)temp = temp+eName;
            if(this.mName!=null)temp = temp+mName;
            if(this.vName!=null)temp = temp+vName;
            return temp;
        }
    };
	...
	if (winSize.width == 0)
	    return;
	dbimage = c.createImage(d.width, d.height);
	scaleworld();
    ...
    class InverseSquaredRadial extends VecFunction {
        String getName() { 
            BUILD_CASE_EMV a = new BUILD_CASE_EMV("point charge", null, "1/r^2 single"); 
            return a.getName();
        }
...
//	    setupBar(0, "Charge Separation", 30);
	...
	VecFunction createNext() { 
	    BUILD_CASE_EMV a = new BUILD_CASE_EMV(new InverseSquaredRadialDipole(),
			   null, new InverseRadial()); 
            return a.getVecFunction();
        }
    };
...
//	    setupBar(0, "Charge Separation", 30);
	...
	double lineLen;
	String getName() { 
            BUILD_CASE_EMV a = new BUILD_CASE_EMV("charged line", null, "1/r single line"); 
            return a.getName();
        }
	void getField(double result[], double y[]) {
	...
	String getName() { 
            BUILD_CASE_EMV a = new BUILD_CASE_EMV("line charge double", null, "1/r double lines"); 
            return a.getName();
        }
	double sign;
	void getField(double result[], double y[]) {
...
//	    setupBar(0, "Line Separation", 30);
	...
	VecFunction createNext() { 
	    BUILD_CASE_EMV a = new BUILD_CASE_EMV(new InverseRadialDipole(), null,
...
//	    setupBar(0, "Slot Size", 60);
	...
	String getName() { 
            BUILD_CASE_EMV a = new BUILD_CASE_EMV(null, "current line",
				  "1/r rotational"); 
            return a.getName();
        }
	void setup() {
	...
	boolean ext;
	String getName() { 
            BUILD_CASE_EMV a = new BUILD_CASE_EMV(null, "current line double",
...
//						 "1/r rotational dipole"); }
	...
	String getName() { 
            BUILD_CASE_EMV a = new BUILD_CASE_EMV(null, "cur line dipole + ext",
						 "1/r rot dipole + ext"); 
            return a.getName();
        }
	...
	String getName() { 
            BUILD_CASE_EMV a = new BUILD_CASE_EMV(null, "uniform field",
						 "one direction"); 
            return a.getName();
        }
	void getField(double result[], double y[]) {
...
//	    setupBar(1, "Phi", 0);
	...
	VecFunction createNext() { 
	    BUILD_CASE_EMV a = new BUILD_CASE_EMV(null, new MovingChargeField(),
	...
	boolean nonGradient() { return true; }
	VecFunction createNext() { 
	       BUILD_CASE_EMV a = new BUILD_CASE_EMV(null, new FastChargeField(), null); 
               return a.getVecFunction();
        }
    };
...
//	    setupBar(0, "Loop Size", 40);
	...
	boolean nonGradient() { return true; }
	VecFunction createNext() {
	     BUILD_CASE_EMV a = new BUILD_CASE_EMV(null, new CurrentLoopsSideField(), null); 
             return a.getVecFunction();
        }
    };
