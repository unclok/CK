 ...
 * @author 기진
 */
public class Vec3DemoFrame extends javax.swing.JFrame
...
//#endif
    ...
    public VecFunction BUILD_CASE_EMV(VecFunction E, VecFunction M, VecFunction V){
        if(E!=null)return E;
    ...
    public String BUILD_CASE_EMV(String Ename, String Mname, String Vname){
        String temp="";
        if(Ename!=null)temp = temp+Ename;
        if(Mname!=null)temp = temp+Mname;
        if(Vname!=null)temp = temp+Vname;
        return temp;
    }

    /**
     * Creates new form Vec3DemoFrame
     */
    public Vec3DemoFrame(VectorDivergenceCurl a) {
...
//#endif
	...
	add(new Label("referred from http://www.falstad.com", Label.CENTER));
	...
	double scalex = view.width*zoom*2/3/2;
	double scaley = view.height*2/3*zoom/2;
...
//#endif
    ...
    void drawGraph(){
        data.clear();
        System.out.print(curfunc.getName());       
	...
	for (int i = 0; i != ct; i++) {
	    double x1 = (double)i*2./ct - 1;
	    double x2 = (double)(i+1.)*2/ct - 1;
	    for (int j = 0; j != ct; j++) {
		double y1 = (double)j*2./ct - 1;
		double y2 = (double)(j+1.)*2/ct - 1;
		pos[coord1] = x1;
		pos[coord2] = y1;
		pos[slice] = z;
...
//#ifdef BUILD_E    
    ...
    private void initComponents() {
        ...
        graphFrame = new javax.swing.JFrame();
